...
export function App() {
  ...
  return <div className={`app-shell${compactViewport ? ' viewport-compact' : ''}`} style={viewportStyle}>
    ...
    <main className="workspace-main">
      ...
      {documentOpen && libraryAssetId && !selected && <LibraryDocument key={libraryAssetId} assetId={libraryAssetId} snapshot={snapshot} onClose={() => navigate('library')} onSelect={assetId => navigate('library', assetId)} onOpenTask={selectTask} />}
    </main>
