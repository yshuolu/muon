...
export function TaskRelations({ tasks, currentId, parentId, onParentChange, blockedByIds, onDependenciesChange }: {
  tasks: Task[]; currentId?: string; parentId: string | null; onParentChange?: (id: string | null) => void;
  blockedByIds: string[]; onDependenciesChange: (ids: string[]) => void;
}) {
